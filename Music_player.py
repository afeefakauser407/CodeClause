...
Button(root, text="Search Music", width=59, height=1, font=("calibri",
      12, "bold"), fg="red", bg="#FFFFFF", command=AddMusic).place(x=0, y=550)

Scroll = Scrollbar(Frame_Music)
Playlist = Listbox(Frame_Music, width=100, font=("Times new roman", 10), bg="#333333", fg="lightblue", selectbackground="lightblue", cursor="hand2", bd=0, yscrollcommand=Scroll.set)
